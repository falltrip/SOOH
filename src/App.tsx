...
const sections = [
  ...
  },
  {
    ...
    title: 'Blog',
    icon: BookOpen,
    description: 'Sharing thoughts and experiences about web development and technology',
  ...
  },
  {
    ...
    title: 'App',
    icon: AppWindow,
    description: 'Showcase of my application development projects and experiments',
